    ...
    <main>
		<div className="px-6 py-12 max-w-screen-xl mx-auto">
			...
			<div className='mb-12 w-full grid grid-cols-1 md:grid-cols-2 gap-4'>
				...
				<div className='my-24'>
					<div className='grid'>
						<div className='text-6xl font-bold text-zinc-800 mb-6'><h1>Intuitive Database Client for TypeScript</h1></div>
							<div> 
						...
						<div>
						<button className='bg-zinc-800 px-6 py-2 rounded text-white border-2 border-transparent font-light mr-3'>Join us</button>
						<button className='bg-white px-6 py-2 rounded font-light border-2 '> <a href="/lp"> Learn more</a></button>
						</div>
					</div>
				</div>
				<div className='grid bg-white-100 w-full place-items-center relative'>
			...
			<div className='grid md:grid-cols-2 my-4 gap-4 mb-24'>
				<div className=''>
			...
			<div className='mx-auto mb-16 '>
				...
				<div className='grid'>
					<div className='mb-8'>
						<button className='mr-8 border-transparent text-md w-fit mt-2 text-white mb-2 border-2 rounded-full bg-sky-600 px-4 py-1.5'>Learn more</button>
						<button className='mr-8 text-md w-fit mt-2 text-sky-600 mb-2 border-2 border-sky-600 rounded-full px-4 py-1.5'>Learn more</button>
					</div>
					<div className='mb-8'>
						<button className='mr-8 bg-sky-600 px-6 py-2 rounded text-white border-2 border-transparent font-light'>Learn more</button>
						<button className='mr-8 px-6 py-2 rounded text-sky-600 border-2 border-sky-600 font-light'>Learn more</button>
					</div>
					<div className='mb-8'>
						<button className='mr-8 text-md w-fit mt-2 text-zinc-800 mb-2 border-2 border-zinc-800 rounded-full px-4 py-1.5'>Learn more</button>
						<button className='mr-8 text-md w-fit mt-2 text-zinc-800 mb-2 border-2 rounded-full px-4 py-1.5'>Learn more</button>
					</div>
					<div className='mb-8'>
						<button className='mr-8 bg-zinc-800 px-6 py-2 rounded text-white border-2 border-transparent font-light'>Learn more</button>
						<button className='mr-8 px-6 py-2 rounded text-zinc-800 border-2 font-light'>Learn more</button>
					</div>
					<div className='mb-8'>
						<button className='mr-8 bg-cyan-100 px-6 py-2 rounded text-zinc-800 border-2 border-transparent font-light'>Learn more →</button>
						<button className='mr-8 bg-zinc-100 px-6 py-2 rounded text-zinc-800 border-2 border-transparent font-light'>Learn more →</button>
					</div>
				</div>
			</div>
			...
			<div className='grid gap-4 px-6rounded-lg bg-zinc-800 mx-auto text-center py-8 mb-24'>
				<p className='text-3xl font-bold text-zinc-100'>The Amplication stack</p>
			...
			<div className='grid gap-4 mt-12 mb-24'>
				<div className='grid gap-4'>
					<div className='text-3xl font-semibold mb-6'>Tile 1</div>
	...
	<path strokeLinecap="round" strokeLinejoin="round" d="M7.5 3.75H6A2.25 2.25 0 003.75 6v1.5M16.5 3.75H18A2.25 2.25 0 0120.25 6v1.5m0 9V18A2.25 2.25 0 0118 20.25h-1.5m-9 0H6A2.25 2.25 0 013.75 18v-1.5M15 12a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
			...
			<div className='grid mb-6'>
				...
				<div className='grid gap-4 mb-24'>
					<div className='h-32 min-w-full rounded bg-zinc-100 px-4 py-4'>FAFAFA / Zinc 100</div>
					<div className='h-32 min-w-full rounded bg-cyan-100 px-4 py-4'>C7EEFF / Cyan 100</div>
					<div className='text-white h-32 min-w-full rounded bg-sky-600 px-4 py-4'>0077C0 / Sky 600</div>
					<div className='text-white h-32 min-w-full rounded bg-zinc-800 px-4 py-4'>1D242B / Zink 800</div>
				</div>
			...
			<div className='border rounded border-gray-300 overflow-hidden'>
				...
				<div className='grid grid-cols-5 bg-gray-50 px-4 py-3 border-b border-gray-200 text-sm'>
					...
					<div>-</div>
					<div>
						<svg viewBox="0 0 256 256" className="w-5 h-5" astro-icon="ph:check-circle-fill"><path fill="currentColor" d="M128 24a104 104 0 1 0 104 104A104.2 104.2 0 0 0 128 24zm49.5 85.8-58.6 56a8.1 8.1 0 0 1-5.6 2.2 7.7 7.7 0 0 1-5.5-2.2l-29.3-28a8 8 0 1 1 11-11.6l23.8 22.7 53.2-50.7a8 8 0 0 1 11 11.6z"></path></svg>
					</div>
					<div>
						<svg viewBox="0 0 256 256" className="w-5 h-5" astro-icon="ph:check-circle-fill"><path fill="currentColor" d="M128 24a104 104 0 1 0 104 104A104.2 104.2 0 0 0 128 24zm49.5 85.8-58.6 56a8.1 8.1 0 0 1-5.6 2.2 7.7 7.7 0 0 1-5.5-2.2l-29.3-28a8 8 0 1 1 11-11.6l23.8 22.7 53.2-50.7a8 8 0 0 1 11 11.6z"></path></svg>
					</div>
				...
				<div className='mx-auto text-center'>
					<h1 className='text-3xl font-semibold mb-4'>Tile 2</h1>
			...
			<div className="mb-12 w-full grid grid-cols-1 md:grid-cols-2 gap-8">
				<div className='p-6 rounded-xl bg-zinc-100 border shadow-sm hover:shadow-lg'>
					<div className='text-sky-600 mb-2 rounded-full bg-cyan-50 border border-sky-200 px-3 py-1 inline-block font-medium text-xs'>Prisma ORM</div>
